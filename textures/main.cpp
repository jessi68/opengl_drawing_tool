...
int main()
{
    ...
    vector<unsigned int> vertextAttributeNumbers;
    vertextAttributeNumbers.push_back(3);
    vertextAttributeNumbers.push_back(3);
    vertextAttributeNumbers.push_back(2);

    Shape cube(vertices, vertextAttributeNumbers, 8, 36);
    cout << sizeof(vertices) << " " << " mainn" << endl;
